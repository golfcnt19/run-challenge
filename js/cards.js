...
import { computeScores, CARDS, CARD_TYPES, weekKey, rawPoints } from "./scoring.js?v=mtx036cz";
import { fmtDateLong } from "./format.js?v=mtx036cz";
import { fmtDateShort, fmtPts, todayIso } from "./format.js?v=mtx036cz";
